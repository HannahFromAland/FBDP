...
- 在eclipse中编写程序student.java并设置pom.xml依赖
      ...
      <plugins>
        ...
        <plugin>
          ...
          <configuration>
					  ...
					  <archive>
					  	<manifest>
						  	<mainClass>hyy.nju.cn.Student</mainClass>
...
- 之后将hbase lib添加到eclipse中，运行students.java
- 开启hbase shell，测试运行结果：

![image.png](https://i.loli.net/2020/11/22/DYUkfr2dOTbKiqV.png)